...
var seq__8190_8194 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__8191_8195 = null;
var count__8192_8196 = (0);
var i__8193_8197 = (0);
while(true){
if((i__8193_8197 < count__8192_8196)){
var str_8198 = cljs.core._nth.call(null,chunk__8191_8195,i__8193_8197);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_8198})));
...
var temp__5720__auto___8203 = cljs.core.seq.call(null,seq__8190_8194);
if(temp__5720__auto___8203){
var seq__8190_8204__$1 = temp__5720__auto___8203;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__8190_8204__$1)){
var c__5568__auto___8205 = cljs.core.chunk_first.call(null,seq__8190_8204__$1);
var G__8206 = cljs.core.chunk_rest.call(null,seq__8190_8204__$1);
var G__8207 = c__5568__auto___8205;
var G__8208 = cljs.core.count.call(null,c__5568__auto___8205);
var G__8209 = (0);
...
var str_8210 = cljs.core.first.call(null,seq__8190_8204__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_8210})));
...
var script__$1 = (function (){var G__8219 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__8219,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__8219,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__8219,"onreadystatechange",onload);

return G__8219;
})();
if((opt_sourceText == null)){
var G__8220 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__8220,"src",src);

return G__8220;
} else {
var G__8221 = script__$1;
goog.dom.setTextContent(G__8221,opt_sourceText);
...
var path_8222 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_8222);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_8222)].join(''));
} else {
var path_8223 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_8223);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_8223);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_8223)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__8224 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__8225 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__8225);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__8224);
}})()})));
}));
