...
var vec__34634 = module$node_modules$react$index.useState(initial);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34634,(0),null);
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34634,(1),null);
var updater = module$node_modules$react$index.useCallback((function() { 
var G__34698__delegate = function (x,xs){
...
var G__34638 = (function helix$hooks$use_state_$_spread_updater(y){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(x,y,xs);
});
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__34638) : u.call(null,G__34638));
} else {
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
}
};
var G__34698 = function (x,var_args){
var xs = null;
if (arguments.length > 1) {
var G__34699__i = 0, G__34699__a = new Array(arguments.length -  1);
while (G__34699__i < G__34699__a.length) {G__34699__a[G__34699__i] = arguments[G__34699__i + 1]; ++G__34699__i;}
  xs = new cljs.core.IndexedSeq(G__34699__a,0,null);
} 
return G__34698__delegate.call(this,x,xs);};
G__34698.cljs$lang$maxFixedArity = 1;
G__34698.cljs$lang$applyTo = (function (arglist__34700){
var x = cljs.core.first(arglist__34700);
var xs = cljs.core.rest(arglist__34700);
return G__34698__delegate(x,xs);
});
...
if((ref.current == null)){
(ref.current = (function (){var x34641 = ({"current": x});
(x34641.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x34641.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x34641.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x34641.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",v);
}));

(x34641.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x34641.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__34643 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__34643) : f.call(null,G__34643));
})());
}));

(x34641.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__34644 = this$__$1.current;
var G__34645 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34644,G__34645) : f.call(null,G__34644,G__34645));
})());
}));

(x34641.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__34647 = this$__$1.current;
var G__34648 = a;
var G__34649 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__34647,G__34648,G__34649) : f.call(null,G__34647,G__34648,G__34649));
})());
}));

(x34641.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
 ...
 */
helix.hooks.use_subscription = (function helix$hooks$use_subscription(p__34689){
var map__34690 = p__34689;
var map__34690__$1 = cljs.core.__destructure_map(map__34690);
var get_current_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34690__$1,new cljs.core.Keyword(null,"get-current-value","get-current-value",-1706578691));
var subscribe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34690__$1,new cljs.core.Keyword(null,"subscribe","subscribe",416253756));
var vec__34691 = module$node_modules$react$index.useState((function (){
...
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34691,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34691,(1),null);
...
return (set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__34694) : set_state.call(null,G__34694));
} else {
return null;
}
});
...
var value = (get_current_value.cljs$core$IFn$_invoke$arity$0 ? get_current_value.cljs$core$IFn$_invoke$arity$0() : get_current_value.call(null));
var G__34695_34731 = ({"get-current-value": get_current_value, "subscribe": subscribe, "value": value});
(set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__34695_34731) : set_state.call(null,G__34695_34731));
