...
var i_33497 = (0);
while(true){
if((i_33497 < arr.length)){
(arr[i_33497] = null);

var G__33498 = (i_33497 + (1));
i_33497 = G__33498;
continue;
} else {
}
...
var i_33508 = (self__.level + (1));
while(true){
if((i_33508 <= (new_level + (1)))){
(update[i_33508] = self__.header);

var G__33514 = (i_33508 + (1));
i_33508 = G__33514;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33515 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33515[i]));
} else {
x__$2.forward.push((((i < links_33515.length))?(links_33515[i]):null));
}

if((i < links_33515.length)){
(links_33515[i] = x__$2);
} else {
links_33515.push(x__$2);
}
...
var i_33518 = (0);
while(true){
if((i_33518 <= self__.level)){
var links_33519 = (update[i_33518]).forward;
if((x__$1 === (((i_33518 < links_33519.length))?(links_33519[i_33518]):null))){
(links_33519[i_33518] = (x__$1.forward[i_33518]));

var G__33520 = (i_33518 + (1));
i_33518 = G__33520;
continue;
} else {
var G__33521 = (i_33518 + (1));
i_33518 = G__33521;
continue;
}
} else {
...
var G__33523 = nx;
var G__33524 = (level__$1 - (1));
x = G__33523;
level__$1 = G__33524;
continue;
} else {
var G__33525 = x;
var G__33526 = (level__$1 - (1));
x = G__33525;
level__$1 = G__33526;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__33532 = nx;
var G__33533 = (level__$1 - (1));
x = G__33532;
level__$1 = G__33533;
continue;
} else {
var G__33534 = x;
var G__33535 = (level__$1 - (1));
x = G__33534;
level__$1 = G__33535;
continue;
}
