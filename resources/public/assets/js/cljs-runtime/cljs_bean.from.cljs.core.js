...
var G__34661 = cljs.core.next(xs);
var G__34662 = cljs.core.next(ys);
xs = G__34661;
ys = G__34662;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__34589 = val;
var G__34590 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34589,G__34590) : f.call(null,G__34589,G__34590));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__34594 = val__$1;
var G__34595 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34594,G__34595) : f.call(null,G__34594,G__34595));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__34596 = val__$1;
var G__34597 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34596,G__34597) : f.call(null,G__34596,G__34597));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__34674 = cljs.core.next(es);
var G__34675 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__34674;
tcoll__$1 = G__34675;
continue;
} else {
...
var G__34677 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__34678 = cljs.core.next(es);
ret = G__34677;
es = G__34678;
continue;
} else {
